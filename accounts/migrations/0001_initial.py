# Generated by Django 5.2.3 on 2025-07-14 14:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=13, unique=True, validators=[django.core.validators.RegexValidator('^\\+255\\d{9}$', 'Use +255XXXXXXXXX format (Tanzanian mobile).')], verbose_name='Mobile Number')),
